...
with(this){return _c('p',[_v("The "),_c('em',[_v("Sequence Diagram")]),_v(" below shows how the components interact with each other for the scenario where the user issues the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete E0123456")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The sequence diagram below illustrates the interactions within the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component, taking "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(\"delete E0123456\")")]),_v(" API call as an example.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("A new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Schedule")]),_v(" can be added by specifying "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("nusId")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("date")]),_v(" and an optional "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("remark")]),_v(". If the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("date")]),_v(" is not specified, the schedule will be removed instead.")])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"schedule-feature-2"}},[_v("Schedule feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#schedule-feature-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The schedule mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ScheduleCommand")]),_v(" and it extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(". A schedule is added if s/ and/or r/ parameter is present. Otherwise if s/ parameter is absent, the schedule is removed. Additionally, it implements the following operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ScheduleCommand#execute()")]),_v(" — Execute the schedule command for the given person.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ScheduleCommand#generateSuccessMessage()")]),_v(" — Generate message for either add schedule or remove schedule.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ScheduleCommand#execute()")]),_v(" is exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic#execute()")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Given below is an example usage scenario and how the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ScheduleCommand")]),_v(" mechanism behaves at each step.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(" will be initialized with the initial address book state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("schedule id/E1234567 s/20-12-2022 r/Consultation at 3pm")]),_v(" command to schedule a consultation session with person nusId E1234567 at date 20-12-2022 in the address book. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("schedule")]),_v(" command calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#getFilteredPersonList()")]),_v(" to get a list of person in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressbook")]),_v(" and filter to find the relevant person with the given nusId. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#setPerson()")]),_v(" is called to update the schedule for that person in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressbook")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. Now the user decides to remove the schedule with that person. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("schedule id/E1234567")]),_v(" to remove the schedule."),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("schedule")]),_v(" again calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#getFilteredPersonList()")]),_v(" and filter to find the relevant person. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#setPerson()")]),_v(" is called to remove the schedule for that person in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressbook")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following sequence diagram shows how a schedule operation goes through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component:")])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Aspect: How schedule executes:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Set the schedule for the person by using s/ parameter. Remove schedule by removing s/ parameter.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: Additional checks are required to check if it is an add or remove schedule command.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Introduce add schedule and remove schedule command as separate commands.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: There is usage of Single Responsibility Principle.")]),_v(" "),_c('li',[_v("Cons: We must ensure that the implementation of each individual command are correct.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{more aspects and alternatives to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_v("Tech-savvy university Computer Science teaching assistants")]),_v(" "),_c('li',[_v("manages an array of students and professors’ contacts")]),_v(" "),_c('li',[_v("appreciates an organized and vibrant approach to query, and manage contacts with CLI")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Thu, 4 Apr 2024, 10:59:10 GMT+8]")])])])}
}];
